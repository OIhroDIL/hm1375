...
//////////////////////////////
  ...
  write_reg(0x0006, 0x0a);  // UBMT Flip Mirror
 ...
 // OPRTCFG : AE gain enabled, PCLK transition on falling edge
  write_reg(0x0023, 0x43);  // IOCNTR : IO pad drive strength
...
/////////////////////////////
  ...
  //////////////////////////////////////////////////
  write_reg(0x032d, 0x4a);
  write_reg(0x032e, 0x01);  
  write_reg(0x032f, 0xf0);
  write_reg(0x0330, 0x00);
  write_reg(0x0331, 0xb2);
  write_reg(0x0332, 0x01);
